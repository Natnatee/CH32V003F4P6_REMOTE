...
- **16 Profiles แบรนด์อุปกรณ์:**
  - `01: SAMSUNG`, `02: LG`, `03: HIKVI`, `04: SHARP`, `05: SONY`, `06: 06` ... `16: 16`
- **3 โหมดการทำงาน:**
  - `SEND`: โหมดยิงสัญญาณปกติ (`SEND 05/16`)
  - `LEARN`: โหมดเรียนรู้จากรีโมทจริง (`LRN  05/16`)
  - `NEW`: โหมดกวาดเทสโค้ดอัตโนมัติ (`NEW  05/16`)
- **การควบคุมปุ่ม:**
  - ปุ่ม `4 (UP)` / `8 (DOWN)` ในหน้า SEND: เลื่อนเปลี่ยนโปรไฟล์แบรนด์ 01..16
  - ปุ่ม `16 (BACK)`: สลับเข้าสู่โหมดเลือก Mode (Footer กระพริบ) แล้วกด 4/8 เลื่อนโหมด และกด 12 (OK) เพื่อยืนยัน
  - ปุ่มในตาราง (1..15): กดแล้วช่องในตารางจะกระพริบไฮไลต์

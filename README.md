...
- **7 โหมดการทำงาน:**
  ...
  - `TETRIS`: โหมดเล่นเกม Tetris คลาสสิก (`[ TETRIS ]`) เล่นบนจอ OLED 64x128 พร้อมระบบคะแนนและ High Score (`HI:xxxxx`)
  - `BIRD`: โหมดเล่นเกม Flappy Bird (`[  BIRD  ]`) บินหลบท่อพิกเซลบนจอ OLED พร้อมระบบ High Score (`HI:xxxxx`)
